...
func main() {
	...
	http.HandleFunc("/calendar.ics", authMiddleware.RequireICalTokenOrAuth(app.HandleICal))
	http.HandleFunc("/api/ical-token/regenerate", authMiddleware.RequireAuth(authHandlers.HandleRegenerateICalToken))
